  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-background py-12">
      ...
      <div className="absolute inset-0 overflow-hidden bg-grid-pattern dark:opacity-30">
        <div className="absolute left-1/4 top-1/3 h-64 w-64 rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 blur-3xl dark:from-primary/10 dark:to-secondary/10"></div>
        <div className="absolute bottom-1/3 right-1/4 h-64 w-64 rounded-full bg-gradient-to-br from-accent/20 to-secondary/20 blur-3xl dark:from-accent/10 dark:to-secondary/10"></div>
      </div>
